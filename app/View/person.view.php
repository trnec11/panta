              ...
              <?php foreach ($items['persons'] as $person) : ?>
                  <tr>
                      <form method="post" action="../../editPerson.php">
                          <td style="display: none"><input name="id" class="input is-info" type="hidden" value="<?= $person->id ?>"></td>
                          <td><input name="prefix_name" class="input is-info" type="text" placeholder="Titul" value="<?= $person->prefix_name ?>"></td>
                          <td><input name="first_name" class="input is-info" type="text" placeholder="Meno" value="<?= $person->first_name ?>"></td>
                          <td><input name="last_name" class="input is-info" type="text" placeholder="Priezvisko" value="<?= $person->last_name ?>"></td>
                          <td><input name="email" class="input is-info" type="text" placeholder="Email" value="<?= $person->email ?>"></td>
                          <td><input name="phone" class="input is-info" type="text" placeholder="Telefon" value="<?= $person->phone ?>"></td>
                          <td><input name="work_position_id" class="input is-info" type="text" placeholder="Pracovna pozicia" value="<?= $person->work_position_id ?>"><?= $items['workPositions'][$person->work_position_id] ?></td>
                          <td class="select">
                              <select name="work_position_id">
                                  <?php foreach ($items['workPositions'] as $key => $workPosition) : ?>
                          ...
                          <td><input name="salary" class="input is-info" type="text" placeholder="Mzda" value="<?= $person->salary ?>"></td>
                          <td>
